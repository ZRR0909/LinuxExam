...
public class CreateNotepad extends HttpServlet {
    ...
    final static String URL = "jdbc:mysql://121.36.227.38/linuxexam";
    final static String USER = "root";
    final static String PASS = "095128zrrA*";
    final static String SQL_INSERT_NOTEPAD = "INSERT INTO notepad(id,notepadname,notepadtime) VALUES (?,?, ?)";
